...
class testens:
	...
	acct = web3.eth.account.privateKeyToAccount("50f3dca79d43c17c0b58b88baf57f0d91212f7ca6a9edc4781c96a5e99fb573d")
	...
	# get bytecode
	bytecode = compiled_sol['contracts']['Registrar.sol']['Registrar']['evm']['bytecode']['object']

	# get abi
	abi = json.loads(compiled_sol['contracts']['Registrar.sol']['Registrar']['metadata'])['output']['abi']

	contract = web3.eth.contract(abi=abi, address=address)

	contract.functions.setup_owner(param, param2).buildTransaction({"from": "0xB4d9313EE835b3d3eE7759826e1F3C3Ac23dFaf3"})
